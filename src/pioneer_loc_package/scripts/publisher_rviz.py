...
right_motor = sim.getObjectHandle("/base_link/rightMotor")
left_motor = sim.getObject("/base_link/leftMotor")
right_wheel = sim.getObjectHandle("/base_link/rightWheel")
left_wheel = sim.getObject("/base_link/leftWheel")
pioneer_robot = sim.getObjectHandle("/base_link")
floor = sim.getObjectHandle("/Floor")
# laser = sim.getObject("/base_link/laser")
...
while not rospy.is_shutdown():
   ...
   # quat_2 = sim.getObjectQuaternion(pioneer_robot, floor)
    ...
    # get_transformer_stamped(
    #     laser, "/base_link/laser", pioneer_robot, "/base_link")
    get_transformer_stamped(
